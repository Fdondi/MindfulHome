...
object ShortcutUiHelper {
    ...
    fun pinnedShortcutToAppInfo(
        ...
        val icon = resolveShortcutIcon(context, shortcut)
    ...
    private fun resolveShortcutIcon(context: Context, shortcut: PinnedShortcut): android.graphics.drawable.Drawable? {
